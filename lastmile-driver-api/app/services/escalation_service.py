...
async def resolve_classification_escalation(
    ...
    *,
    ...
    if next_state == OccurrenceState.CLOSED_DEFINITIVE_FAILURE:
        ...
        driver_key = DRIVER_REFUSED_CLOSED
        driver_kwargs = {}
    else:
        driver_key = DRIVER_REPORT_RECEIVED_NOTICE
        driver_kwargs = {"failure_reason": failure_reason.value}
...
async def resolve_reply_escalation(
    ...
    *,
    ...
    if category == ReplyCategory.CONFIRMS_RESCHEDULE:
        ...
        driver_key = DRIVER_DEFINITIVE_FAILURE
        driver_text = render_template(tenant, driver_key)
        ...
        if within_radius:
            ...
            customer_kwargs = {"new_address": new_address_text}
            driver_key = DRIVER_NEW_INSTRUCTION_APPROVED
            driver_kwargs = {"new_address": new_address_text}
        else:
            next_state = OccurrenceState.CLOSED_DEFINITIVE_FAILURE
