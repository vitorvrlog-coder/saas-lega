...
ENDEREÇO ORIGINAL da entrega, o NÚMERO DA PARADA/SEQUÊNCIA da rota e o
NÚMERO DA NOTA FISCAL/PEDIDO, caso o motorista já tenha incluído essas
informações no relato (alguns motoristas mandam tudo de uma vez, outros só
o motivo — todos os casos são válidos). Motoristas com planilha de rota
costumam citar número de parada; motoristas de distribuidora sem planilha
costumam citar número da nota fiscal — ambos são válidos, extraia o que
estiver presente.
...
Responda APENAS com um JSON no formato exato, sem nenhum texto fora dele:
{
  ...
  "order_number": "<número da nota fiscal/pedido, exatamente como escrito, ou null>",
...
- stop_number: só preencha se o motorista citar explicitamente um número de parada/sequência/entrega (ex: "parada 12", "entrega 5"). Nunca invente, nunca confunda com outro número da mensagem (endereço, telefone, nota fiscal). Se não tiver certeza, deixe null.
- order_number: só preencha se o motorista citar explicitamente um número de nota fiscal/pedido (ex: "nota 12345", "pedido 987"). Nunca invente, nunca confunda com stop_number ou outro número da mensagem. Se não tiver certeza, deixe null.
"""
